...
{
    public partial class HajReza22 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SupportTicketAggId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketReplies", x => new { x.SupportTicketAggId, x.Id });
                    table.ForeignKey(
                        name: "FK_TicketReplies_SupportTicket_SupportTicketAggId",
                        column: x => x.SupportTicketAggId,
                        principalSchema: "supportTicket",
