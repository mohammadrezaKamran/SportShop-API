...
namespace Shop.Infrastructure.Migrations
{
    ...
    [Migration("20250220135115_HajReza22")]
    partial class HajReza22
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shop.Domain.SupportTicketAgg.SupportTicketAgg", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("SupportTicket", "supportTicket");
                });
            ...
            modelBuilder.Entity("Shop.Domain.UserAgg.WishList", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Shop.Domain.ProductAgg.Product", b =>
                {
                    b.OwnsOne("ProductInventory", "Inventory", b1 =>
                        {
                            ...
                            b1.ToTable("ProductInventories", "product");
            ...
            modelBuilder.Entity("Shop.Domain.SupportTicketAgg.SupportTicketAgg", b =>
                {
                    b.OwnsMany("Shop.Domain.SupportTicketAgg.TicketReply", "Replies", b1 =>
                        {
                            b1.Property<long>("SupportTicketAggId")
                                .HasColumnType("bigint");
                            ...
                            b1.HasKey("SupportTicketAggId", "Id");

                            b1.HasIndex("AdminId");

                            b1.ToTable("TicketReplies", "SupportTicket");

                            b1.WithOwner()
                                .HasForeignKey("SupportTicketAggId");
                        });
            ...
            modelBuilder.Entity("Shop.Domain.UserAgg.User", b =>
                {
                    b.OwnsOne("Shop.Domain.UserAgg.UserAddress", "Address", b1 =>
                        {
